      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="flex items-baseline gap-4 sm:gap-8 mb-8 sm:mb-12 overflow-hidden">
          <span className="hero-label font-mono text-[10px] sm:text-[11px] tracking-[0.12em] text-muted uppercase flex-shrink-0">
            Frontend Engineer | JavaScript Engineer
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mt-12 sm:mt-16 max-w-3xl">
          <div
            ...
            data-cursor
          >
            <span className="font-mono text-[10px] tracking-[0.14em] text-muted uppercase block mb-1">01</span>
            <span className="font-display text-[18px] font-bold tracking-[-0.01em] text-fg">About</span>
          </div>
          <div
            ...
            data-cursor
          >
            <span className="font-mono text-[10px] tracking-[0.14em] text-muted uppercase block mb-1">02</span>
            <span className="font-display text-[18px] font-bold tracking-[-0.01em] text-fg">Projects</span>
          </div>
          <div
            ...
            data-cursor
          >
            <span className="font-mono text-[10px] tracking-[0.14em] text-muted uppercase block mb-1">03</span>
            <span className="font-display text-[18px] font-bold tracking-[-0.01em] text-fg">Contact</span>
          </div>
        </div>
      </div>
    </header>
